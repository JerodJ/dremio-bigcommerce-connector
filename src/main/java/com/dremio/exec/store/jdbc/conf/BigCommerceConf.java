...
@SourceType(value = "BigCommerceARP", label = "BigCommerce",uiConfig = "bigcommerce-layout.json")
public class BigCommerceConf extends AbstractArpConf<BigCommerceConf> {
  private static final String ARP_FILENAME = "arp/implementation/bigcommerce-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.bigcommerce.BigCommerceDriver";
