...
3. Download and install the [BigCommerce JDBC Driver from CData](https://www.cdata.com/drivers/bigcommerce/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
